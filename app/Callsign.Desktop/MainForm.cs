    ...
    private async void OnShown(object? sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            var choice = MessageBox.Show(
                "BentoFly needs the Microsoft Edge WebView2 runtime, which doesn't seem to be installed.\n\n" +
                "Click OK to open the free download page, then run BentoFly again.\n\n(" + ex.Message + ")",
                "BentoFly — WebView2 required", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
